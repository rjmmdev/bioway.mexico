...
import '../../../services/bioway/inactivity_cleanup_service.dart';
...
class CentroAcopioHomeScreen extends StatefulWidget {
  const CentroAcopioHomeScreen({Key? key}) : super(key: key);
...
class _CentroAcopioHomeScreenState extends State<CentroAcopioHomeScreen> {
  ...
  Future<void> _updateActivity() async {
    ...
    if (user != null) {
      await InactivityCleanupService.updateUserActivity(
        user.uid,
