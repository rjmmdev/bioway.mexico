...
import '../reciclador/widgets/reciclador_bottom_navigation.dart'; // Para NavigationHelper
  ...
  void _onBottomNavTapped(int index) {
    ...
    switch (index) {
      ...
      case 3:
        NavigationHelper.navigateWithReplacement(
          context: context,
          destination: const LaboratorioPerfilScreen(),
        );
        break;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: LaboratorioBottomNavigation(
        ...
        onFabPressed: _navigateToNewMuestra,
      ),
  ...
  void _onMuestraTap(Muestra muestra) {
    ...
    switch (muestra.estado) {
      case 'formulario':
        NavigationHelper.navigateWithSlideTransition(
          context: context,
          destination: LaboratorioFormulario(
