...
class _LaboratorioTomaMuestraMegaloteScreenState extends State<LaboratorioTomaMuestraMegaloteScreen> {
  ...
  bool _hasPhotos = false; // Flag para tracking del estado de fotos
  ...
  void _onPhotosChanged(List<File> photos) {
    setState(() {
      _photoFiles = photos;
      _hasPhotos = photos.isNotEmpty; // Actualizar flag de estado
    });
  }
        ...
        leading: IconButton(
          ...
          onPressed: () async {
            ...
            if (_signaturePoints.isNotEmpty || _photoFiles.isNotEmpty) {
              final shouldLeave = await DialogUtils.showConfirmDialog(
                context: context,
                title: '¿Abandonar formulario?',
                message: 'Los datos capturados se perderán. ¿Desea continuar?',
              );
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            onTap: !_hasSignature ? () => _showSignatureDialog() : null,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          PhotoEvidenceWidget(
            title: '', // Título vacío porque ya lo mostramos arriba
            maxPhotos: 3,
            minPhotos: 0,
            isRequired: false,
